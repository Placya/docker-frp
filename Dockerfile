...
COPY container-files/frp_0.21.0_linux_amd64.tar.gz frp.tar.gz
...
RUN echo -e "https://mirrors.aliyun.com/alpine/v3.6/main" > /etc/apk/repositories \
    ...
    && mv frp_0.21.0_linux_amd64/frps /bin/frps \
    && mv frp_0.21.0_linux_amd64/frpc /bin/frpc \
    && rm -rf frp_0.21.0_linux_amd64 \
    && mkdir -p /home/conf \
